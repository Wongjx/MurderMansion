...
public class DesktopRelaySocketFactory implements RelaySocketFactory {
	@Override
	public RelaySocketClient create() {
		return new DesktopRelaySocketClient();
	}

	private static class DesktopRelaySocketClient implements RelaySocketClient {
